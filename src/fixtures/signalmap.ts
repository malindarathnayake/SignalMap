...
export const SOURCE_HEALTH_FIXTURE = {
  sources: [
    ...
    { id: 'openai-status', label: 'OpenAI Status',             tier: 1, status: 'ok' as const,        latencyMs: 165 },
    { id: 'claude-status', label: 'Anthropic Status',          tier: 1, status: 'ok' as const,        latencyMs: 142 },
    { id: 'aws-lambda-use1', label: 'AWS Lambda — us-east-1', tier: 1, status: 'ok' as const,    latencyMs: 178 },
    { id: 'aws-lambda-use2', label: 'AWS Lambda — us-east-2', tier: 1, status: 'ok' as const,    latencyMs: 184 },
    { id: 'aws-rds-use1',    label: 'AWS RDS — us-east-1',    tier: 1, status: 'ok' as const,    latencyMs: 192 },
    { id: 'aws-s3-use1',     label: 'AWS S3 — us-east-1',     tier: 1, status: 'ok' as const,    latencyMs: 156 },
