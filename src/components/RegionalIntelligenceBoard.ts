...
/**
 * RegionalIntelligenceBoard — panel rendering a canonical
...
export class RegionalIntelligenceBoard extends Panel {
  ...
  private async loadCurrent(): Promise<void> {
    // Skip RPCs when this app instance is running inside an embedded preview.
    // The empty path keeps the preview quiet.
